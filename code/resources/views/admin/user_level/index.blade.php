    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('admin/user_level/search') }}" method="post">
                            {{ csrf_field() }}
                            @php
                                $keyword = "";
                                if($search != "all"){
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="{{ url('admin/user_level/info/new') }}" class="btn btn-block btn-primary">Add New</a>
                                </div>
                                <div class="col-md-8">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ url('admin/user_level/info/'.$value->id) }}">Edit</a>
                                                    <a class="dropdown-item" href="javascript:void(0)" onclick="document.getElementById('hapusData{{ $value->id }}').submit();">Delete</a>
                                                    <form action="{{ url('admin/user_level/delete/'.$value->id) }}" method="post" id="hapusData{{ $value->id }}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
                                                    </form>
                                                </div>
